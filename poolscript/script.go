...
func TaprootKey(scriptVersion Version, expiry uint32, traderKey, auctioneerKey,
	...
	*txscript.TapLeaf, error) {
	...
	var (
		...
		signerKeys    = []*btcec.PublicKey{auctioneerKey, traderKey}
	...
	case VersionTaprootMuSig2:
		...
		signerKeys[0], err = schnorr.ParsePubKey(
		...
		signerKeys[1], err = schnorr.ParsePubKey(
	...
	aggregateKey, err := input.MuSig2CombineKeys(
		muSig2Version, signerKeys, true, &input.MuSig2Tweaks{
