...
func (x *OrderMetricsRequest) Reset() {
	*x = OrderMetricsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_auctioneer_proto_msgTypes[63]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*OrderMetricsRequest) Descriptor() ([]byte, []int) {
	return file_auctioneer_proto_rawDescGZIP(), []int{63}
}
...
type OrderMetrics struct {
	...
	// The number of open/pending ask orders per lease duration.
	NumAsks int64 `protobuf:"varint,1,opt,name=num_asks,json=numAsks,proto3" json:"num_asks,omitempty"`
	// The number of open/pending bid orders per lease duration.
	NumBids int64 `protobuf:"varint,2,opt,name=num_bids,json=numBids,proto3" json:"num_bids,omitempty"`
	// The total volume of ask orders per lease duration.
	AskVolume int64 `protobuf:"varint,3,opt,name=ask_volume,json=askVolume,proto3" json:"ask_volume,omitempty"`
	// The total volume of bid orders per lease duration.
	BidVolume int64 `protobuf:"varint,4,opt,name=bid_volume,json=bidVolume,proto3" json:"bid_volume,omitempty"`
}

func (x *OrderMetrics) Reset() {
	*x = OrderMetrics{}
	if protoimpl.UnsafeEnabled {
		mi := &file_auctioneer_proto_msgTypes[64]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*OrderMetrics) Descriptor() ([]byte, []int) {
	return file_auctioneer_proto_rawDescGZIP(), []int{64}
}

func (x *OrderMetrics) GetNumAsks() int64 {
	if x != nil {
		return x.NumAsks
	}
	return 0
...
func (x *OrderMetrics) GetNumBids() int64 {
	if x != nil {
		return x.NumBids
	}
	return 0
...
func (x *OrderMetrics) GetAskVolume() int64 {
	if x != nil {
		return x.AskVolume
	}
	return 0
...
func (x *OrderMetrics) GetBidVolume() int64 {
	if x != nil {
		return x.BidVolume
	}
	return 0
...
type OrderMetricsResponse struct {
	...
	// A map of all orders identified by their time frame and the current
	// set of statistics.
	OrderMetricsByLeaseDuration map[uint32]*OrderMetrics `protobuf:"bytes,1,rep,name=order_metrics_by_lease_duration,json=orderMetricsByLeaseDuration,proto3" json:"order_metrics_by_lease_duration,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}

func (x *OrderMetricsResponse) Reset() {
	*x = OrderMetricsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_auctioneer_proto_msgTypes[65]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*OrderMetricsResponse) Descriptor() ([]byte, []int) {
	return file_auctioneer_proto_rawDescGZIP(), []int{65}
}

func (x *OrderMetricsResponse) GetOrderMetricsByLeaseDuration() map[uint32]*OrderMetrics {
	if x != nil {
		return x.OrderMetricsByLeaseDuration
	}
	return nil
}
...
func (x *BatchMetricsRequest) Reset() {
	*x = BatchMetricsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_auctioneer_proto_msgTypes[66]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*BatchMetricsRequest) Descriptor() ([]byte, []int) {
	return file_auctioneer_proto_rawDescGZIP(), []int{66}
}
...
type BatchMetrics struct {
	...
	// The number of open/pending ask orders per lease duration.
	TotalSatsLeased int64 `protobuf:"varint,1,opt,name=total_sats_leased,json=totalSatsLeased,proto3" json:"total_sats_leased,omitempty"`
	// The number of open/pending bid orders per lease duration.
	TotalFeesAccrued int64 `protobuf:"varint,2,opt,name=total_fees_accrued,json=totalFeesAccrued,proto3" json:"total_fees_accrued,omitempty"`
	// The APR of the matched order sizes.
	MedianOrderSize float64 `protobuf:"fixed64,3,opt,name=median_order_size,json=medianOrderSize,proto3" json:"median_order_size,omitempty"`
	// The median APR of all batches.
	MedianApr float64 `protobuf:"fixed64,4,opt,name=median_apr,json=medianApr,proto3" json:"median_apr,omitempty"`
}

func (x *BatchMetrics) Reset() {
	*x = BatchMetrics{}
	if protoimpl.UnsafeEnabled {
		mi := &file_auctioneer_proto_msgTypes[67]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*BatchMetrics) Descriptor() ([]byte, []int) {
	return file_auctioneer_proto_rawDescGZIP(), []int{67}
}

func (x *BatchMetrics) GetTotalSatsLeased() int64 {
	if x != nil {
		return x.TotalSatsLeased
	}
	return 0
}

func (x *BatchMetrics) GetTotalFeesAccrued() int64 {
	if x != nil {
		return x.TotalFeesAccrued
	}
	return 0
}

func (x *BatchMetrics) GetMedianOrderSize() float64 {
	if x != nil {
		return x.MedianOrderSize
	}
	return 0
}

func (x *BatchMetrics) GetMedianApr() float64 {
	if x != nil {
		return x.MedianApr
	}
	return 0
...
type BatchMetricsResponse struct {
	...
	// A map of all batch metrics identified by their timeframe and the current
	// set of statistics.
	BatchMetricsByTimeframe map[uint64]*BatchMetricsByLeaseDuration `protobuf:"bytes,1,rep,name=batch_metrics_by_timeframe,json=batchMetricsByTimeframe,proto3" json:"batch_metrics_by_timeframe,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	// A map of all weekly metrics, mapped from timeframe (day) to weekly
	// metrics.
	WeeklyVolumeMetricsByDuration map[string]*WeeklyVolumeMetrics `protobuf:"bytes,2,rep,name=weekly_volume_metrics_by_duration,json=weeklyVolumeMetricsByDuration,proto3" json:"weekly_volume_metrics_by_duration,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (*BatchMetricsResponse) Descriptor() ([]byte, []int) {
	return file_auctioneer_proto_rawDescGZIP(), []int{68}
}

func (x *BatchMetricsResponse) GetBatchMetricsByTimeframe() map[uint64]*BatchMetricsByLeaseDuration {
	if x != nil {
		return x.BatchMetricsByTimeframe
	}
	return nil
}

func (x *BatchMetricsResponse) GetWeeklyVolumeMetricsByDuration() map[string]*WeeklyVolumeMetrics {
	if x != nil {
		return x.WeeklyVolumeMetricsByDuration
	}
	return nil
}

type BatchMetricsByLeaseDuration struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// A map of all lease durations to batch metrics.
	BatchMetricsByDuration map[uint32]*BatchMetrics `protobuf:"bytes,1,rep,name=batch_metrics_by_duration,json=batchMetricsByDuration,proto3" json:"batch_metrics_by_duration,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}

func (x *BatchMetricsByLeaseDuration) Reset() {
	*x = BatchMetricsByLeaseDuration{}
	if protoimpl.UnsafeEnabled {
		mi := &file_auctioneer_proto_msgTypes[69]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *BatchMetricsByLeaseDuration) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BatchMetricsByLeaseDuration) ProtoMessage() {}

func (x *BatchMetricsByLeaseDuration) ProtoReflect() protoreflect.Message {
	mi := &file_auctioneer_proto_msgTypes[69]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BatchMetricsByLeaseDuration.ProtoReflect.Descriptor instead.
func (*BatchMetricsByLeaseDuration) Descriptor() ([]byte, []int) {
	return file_auctioneer_proto_rawDescGZIP(), []int{69}
}

func (x *BatchMetricsByLeaseDuration) GetBatchMetricsByDuration() map[uint32]*BatchMetrics {
	if x != nil {
		return x.BatchMetricsByDuration
	}
	return nil
}

type WeeklyVolumeMetrics struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// A map of the lease duration to total volume.
	TotalVolume map[uint32]int64 `protobuf:"bytes,1,rep,name=total_volume,json=totalVolume,proto3" json:"total_volume,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
	// The current day of the month (timestamp.String()).
	CurrentDay string `protobuf:"bytes,2,opt,name=current_day,json=currentDay,proto3" json:"current_day,omitempty"`
}

func (x *WeeklyVolumeMetrics) Reset() {
	*x = WeeklyVolumeMetrics{}
	if protoimpl.UnsafeEnabled {
		mi := &file_auctioneer_proto_msgTypes[70]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *WeeklyVolumeMetrics) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WeeklyVolumeMetrics) ProtoMessage() {}

func (x *WeeklyVolumeMetrics) ProtoReflect() protoreflect.Message {
	mi := &file_auctioneer_proto_msgTypes[70]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WeeklyVolumeMetrics.ProtoReflect.Descriptor instead.
func (*WeeklyVolumeMetrics) Descriptor() ([]byte, []int) {
	return file_auctioneer_proto_rawDescGZIP(), []int{70}
}

func (x *WeeklyVolumeMetrics) GetTotalVolume() map[uint32]int64 {
	if x != nil {
...
func (x *WeeklyVolumeMetrics) GetCurrentDay() string {
	if x != nil {
		return x.CurrentDay
	}
	return ""
...
func (x *ServerModifyAccountRequest_NewAccountParameters) Reset() {
	*x = ServerModifyAccountRequest_NewAccountParameters{}
	if protoimpl.UnsafeEnabled {
		mi := &file_auctioneer_proto_msgTypes[79]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (x *MarketInfo_TierValue) Reset() {
	*x = MarketInfo_TierValue{}
	if protoimpl.UnsafeEnabled {
		mi := &file_auctioneer_proto_msgTypes[85]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
var file_auctioneer_proto_rawDesc = []byte{
	...
	0x5f, 0x46, 0x55, 0x4c, 0x4c, 0x59, 0x5f, 0x53, 0x50, 0x45, 0x4e, 0x54, 0x10, 0x03, 0x22, 0xb1,
	...
	0x65, 0x64, 0x4e, 0x6f, 0x64, 0x65, 0x49, 0x64, 0x73, 0x12, 0x1b, 0x0a, 0x09, 0x69, 0x73, 0x5f,
	0x70, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x18, 0x11, 0x20, 0x01, 0x28, 0x08, 0x52, 0x08, 0x69, 0x73,
	0x50, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x4a, 0x04, 0x08, 0x05, 0x10, 0x06, 0x4a, 0x04, 0x08, 0x0b,
	0x10, 0x0c, 0x22, 0xfd, 0x02, 0x0a, 0x09, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x42, 0x69, 0x64,
	...
	,
	...
	0x13, 0x6c, 0x65, 0x61, 0x73, 0x65, 0x44, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x42, 0x6c,
	0x6f, 0x63, 0x6b, 0x73, 0x12, 0x18, 0x0a, 0x07, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x18,
	0x05, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x07, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x62,
	0x0a, 0x18, 0x61, 0x6e, 0x6e, 0x6f, 0x75, 0x6e, 0x63, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x5f, 0x63,
	0x6f, 0x6e, 0x73, 0x74, 0x72, 0x61, 0x69, 0x6e, 0x74, 0x73, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0e,
	...
	0x6f, 0x6e, 0x5f, 0x63, 0x6f, 0x6e, 0x73, 0x74, 0x72, 0x61, 0x69, 0x6e, 0x74, 0x73, 0x18, 0x07,
	...
	,
	...
	,
	...
	0x52, 0x06, 0x65, 0x78, 0x70, 0x69, 0x72, 0x79, 0x12, 0x18, 0x0a, 0x07, 0x76, 0x65, 0x72, 0x73,
	0x69, 0x6f, 0x6e, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x07, 0x76, 0x65, 0x72, 0x73, 0x69,
	0x6f, 0x6e, 0x22, 0x63, 0x0a, 0x1b, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x4d, 0x6f, 0x64, 0x69,
	...
	0x69, 0x67, 0x12, 0x23, 0x0a, 0x0d, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x5f, 0x6e, 0x6f, 0x6e,
	0x63, 0x65, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0c, 0x73, 0x65, 0x72, 0x76, 0x65,
	0x72, 0x4e, 0x6f, 0x6e, 0x63, 0x65, 0x73, 0x22, 0x3a, 0x0a, 0x17, 0x53, 0x65, 0x72, 0x76, 0x65,
	0x72, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x12, 0x1f, 0x0a, 0x0b, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x5f, 0x6e, 0x6f, 0x6e, 0x63,
	0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0a, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x4e, 0x6f,
	0x6e, 0x63, 0x65, 0x22, 0x72, 0x0a, 0x18, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x4f, 0x72, 0x64,
	...
	,
	...
	,
	...
	,
	...
	0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x29, 0x2e, 0x70, 0x6f, 0x6f, 0x6c, 0x72, 0x70,
	0x63, 0x2e, 0x52, 0x65, 0x6c, 0x65, 0x76, 0x61, 0x6e, 0x74, 0x42, 0x61, 0x74, 0x63, 0x68, 0x2e,
	0x4d, 0x61, 0x74, 0x63, 0x68, 0x65, 0x64, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x73, 0x45, 0x6e, 0x74,
	...
	,
	...
	0x07, 0x66, 0x65, 0x65, 0x52, 0x61, 0x74, 0x65, 0x22, 0x3b, 0x0a, 0x0b, 0x4e, 0x6f, 0x64, 0x65,
	...
	0x04, 0x61, 0x64, 0x64, 0x72, 0x22, 0x41, 0x0a, 0x08, 0x4f, 0x75, 0x74, 0x50, 0x6f, 0x69, 0x6e,
	...
	0x70, 0x75, 0x74, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x22, 0xb2, 0x01, 0x0a, 0x0b, 0x41, 0x73, 0x6b,
	...
	0x6f, 0x6e, 0x12, 0x32, 0x0a, 0x15, 0x6c, 0x65, 0x61, 0x73, 0x65, 0x5f, 0x64, 0x75, 0x72, 0x61,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x79, 0x12, 0x2e, 0x0a, 0x09, 0x6e, 0x6f, 0x64, 0x65, 0x5f, 0x74, 0x69, 0x65, 0x72, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x0e, 0x32, 0x11, 0x2e, 0x70, 0x6f, 0x6f, 0x6c, 0x72, 0x70, 0x63, 0x2e, 0x4e,
	0x6f, 0x64, 0x65, 0x54, 0x69, 0x65, 0x72, 0x52, 0x08, 0x6e, 0x6f, 0x64, 0x65, 0x54, 0x69, 0x65,
	0x72, 0x22, 0x52, 0x0a, 0x18, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x4e, 0x6f, 0x64, 0x65, 0x52,
	...
	,
	...
	,
	...
	,
	...
	0x72, 0x79, 0x52, 0x07, 0x6d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x73, 0x1a, 0x4f, 0x0a, 0x0c, 0x4d,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x49, 0x4c, 0x45, 0x44, 0x10, 0x06, 0x2a, 0x5e, 0x0a, 0x13, 0x44, 0x75, 0x72, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x42, 0x75, 0x63, 0x6b, 0x65, 0x74, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x0d, 0x0a,
	0x09, 0x4e, 0x4f, 0x5f, 0x4d, 0x41, 0x52, 0x4b, 0x45, 0x54, 0x10, 0x00, 0x12, 0x11, 0x0a, 0x0d,
	0x4d, 0x41, 0x52, 0x4b, 0x45, 0x54, 0x5f, 0x43, 0x4c, 0x4f, 0x53, 0x45, 0x44, 0x10, 0x01, 0x12,
	0x14, 0x0a, 0x10, 0x41, 0x43, 0x43, 0x45, 0x50, 0x54, 0x49, 0x4e, 0x47, 0x5f, 0x4f, 0x52, 0x44,
	0x45, 0x52, 0x53, 0x10, 0x02, 0x12, 0x0f, 0x0a, 0x0b, 0x4d, 0x41, 0x52, 0x4b, 0x45, 0x54, 0x5f,
	0x4f, 0x50, 0x45, 0x4e, 0x10, 0x03, 0x32, 0xa7, 0x0a, 0x0a, 0x11, 0x43, 0x68, 0x61, 0x6e, 0x6e,
	...
	,
	...
	,
	...
	,
	...
	0x69, 0x67, 0x68, 0x74, 0x6e, 0x69, 0x6e, 0x67, 0x6c, 0x61, 0x62, 0x73, 0x2f, 0x70, 0x6f, 0x6f,
	0x6c, 0x2f, 0x61, 0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x65, 0x65, 0x72, 0x72, 0x70, 0x63, 0x62,
...
var file_auctioneer_proto_msgTypes = make([]protoimpl.MessageInfo, 92)
var file_auctioneer_proto_goTypes = []interface{}{
	...
	(*OrderMetricsRequest)(nil),         // 76: poolrpc.OrderMetricsRequest
	(*OrderMetrics)(nil),                // 77: poolrpc.OrderMetrics
	(*OrderMetricsResponse)(nil),        // 78: poolrpc.OrderMetricsResponse
	(*BatchMetricsRequest)(nil),         // 79: poolrpc.BatchMetricsRequest
	(*BatchMetrics)(nil),                // 80: poolrpc.BatchMetrics
	(*BatchMetricsResponse)(nil),        // 81: poolrpc.BatchMetricsResponse
	(*BatchMetricsByLeaseDuration)(nil), // 82: poolrpc.BatchMetricsByLeaseDuration
	(*WeeklyVolumeMetrics)(nil),         // 83: poolrpc.WeeklyVolumeMetrics
	nil,                                 // 84: poolrpc.OrderMatchReject.RejectedOrdersEntry
	nil,                                 // 85: poolrpc.OrderMatchSign.AccountSigsEntry
	nil,                                 // 86: poolrpc.OrderMatchSign.ChannelInfosEntry
	nil,                                 // 87: poolrpc.OrderMatchSign.TraderNoncesEntry
	nil,                                 // 88: poolrpc.MatchedMarket.MatchedOrdersEntry
	nil,                                 // 89: poolrpc.OrderMatchPrepare.MatchedOrdersEntry
	nil,                                 // 90: poolrpc.OrderMatchPrepare.MatchedMarketsEntry
	nil,                                 // 91: poolrpc.OrderMatchSignBegin.ServerNoncesEntry
	(*ServerModifyAccountRequest_NewAccountParameters)(nil), // 92: poolrpc.ServerModifyAccountRequest.NewAccountParameters
	nil,                          // 93: poolrpc.TermsResponse.LeaseDurationsEntry
	nil,                          // 94: poolrpc.TermsResponse.LeaseDurationBucketsEntry
	nil,                          // 95: poolrpc.RelevantBatch.MatchedOrdersEntry
	nil,                          // 96: poolrpc.RelevantBatch.MatchedMarketsEntry
	nil,                          // 97: poolrpc.BatchSnapshotResponse.MatchedMarketsEntry
	(*MarketInfo_TierValue)(nil), // 98: poolrpc.MarketInfo.TierValue
	nil,                          // 99: poolrpc.MarketInfoResponse.MarketsEntry
	nil,                          // 100: poolrpc.OrderMetricsResponse.OrderMetricsByLeaseDurationEntry
	nil,                          // 101: poolrpc.BatchMetricsResponse.BatchMetricsByTimeframeEntry
	nil,                          // 102: poolrpc.BatchMetricsResponse.WeeklyVolumeMetricsByDurationEntry
	nil,                          // 103: poolrpc.BatchMetricsByLeaseDuration.BatchMetricsByDurationEntry
	nil,                          // 104: poolrpc.WeeklyVolumeMetrics.TotalVolumeEntry
}
var file_auctioneer_proto_depIdxs = []int32{
	...
	84,  // 11: poolrpc.OrderMatchReject.rejected_orders:type_name -> poolrpc.OrderMatchReject.RejectedOrdersEntry
	...
	85,  // 14: poolrpc.OrderMatchSign.account_sigs:type_name -> poolrpc.OrderMatchSign.AccountSigsEntry
	86,  // 15: poolrpc.OrderMatchSign.channel_infos:type_name -> poolrpc.OrderMatchSign.ChannelInfosEntry
	87,  // 16: poolrpc.OrderMatchSign.trader_nonces:type_name -> poolrpc.OrderMatchSign.TraderNoncesEntry
	...
	88,  // 24: poolrpc.MatchedMarket.matched_orders:type_name -> poolrpc.MatchedMarket.MatchedOrdersEntry
	89,  // 25: poolrpc.OrderMatchPrepare.matched_orders:type_name -> poolrpc.OrderMatchPrepare.MatchedOrdersEntry
	...
	90,  // 28: poolrpc.OrderMatchPrepare.matched_markets:type_name -> poolrpc.OrderMatchPrepare.MatchedMarketsEntry
	91,  // 29: poolrpc.OrderMatchSignBegin.server_nonces:type_name -> poolrpc.OrderMatchSignBegin.ServerNoncesEntry
	...
	92,  // 51: poolrpc.ServerModifyAccountRequest.new_params:type_name -> poolrpc.ServerModifyAccountRequest.NewAccountParameters
	...
	93,  // 55: poolrpc.TermsResponse.lease_durations:type_name -> poolrpc.TermsResponse.LeaseDurationsEntry
	94,  // 56: poolrpc.TermsResponse.lease_duration_buckets:type_name -> poolrpc.TermsResponse.LeaseDurationBucketsEntry
	43,  // 57: poolrpc.RelevantBatch.charged_accounts:type_name -> poolrpc.AccountDiff
	95,  // 58: poolrpc.RelevantBatch.matched_orders:type_name -> poolrpc.RelevantBatch.MatchedOrdersEntry
	59,  // 59: poolrpc.RelevantBatch.execution_fee:type_name -> poolrpc.ExecutionFee
	96,  // 60: poolrpc.RelevantBatch.matched_markets:type_name -> poolrpc.RelevantBatch.MatchedMarketsEntry
	...
	97,  // 67: poolrpc.BatchSnapshotResponse.matched_markets:type_name -> poolrpc.BatchSnapshotResponse.MatchedMarketsEntry
	...
	98,  // 71: poolrpc.MarketInfo.num_asks:type_name -> poolrpc.MarketInfo.TierValue
	98,  // 72: poolrpc.MarketInfo.num_bids:type_name -> poolrpc.MarketInfo.TierValue
	98,  // 73: poolrpc.MarketInfo.ask_open_interest_units:type_name -> poolrpc.MarketInfo.TierValue
	98,  // 74: poolrpc.MarketInfo.bid_open_interest_units:type_name -> poolrpc.MarketInfo.TierValue
	99,  // 75: poolrpc.MarketInfoResponse.markets:type_name -> poolrpc.MarketInfoResponse.MarketsEntry
	100, // 76: poolrpc.OrderMetricsResponse.order_metrics_by_lease_duration:type_name -> poolrpc.OrderMetricsResponse.OrderMetricsByLeaseDurationEntry
	101, // 77: poolrpc.BatchMetricsResponse.batch_metrics_by_timeframe:type_name -> poolrpc.BatchMetricsResponse.BatchMetricsByTimeframeEntry
	102, // 78: poolrpc.BatchMetricsResponse.weekly_volume_metrics_by_duration:type_name -> poolrpc.BatchMetricsResponse.WeeklyVolumeMetricsByDurationEntry
	103, // 79: poolrpc.BatchMetricsByLeaseDuration.batch_metrics_by_duration:type_name -> poolrpc.BatchMetricsByLeaseDuration.BatchMetricsByDurationEntry
	104, // 80: poolrpc.WeeklyVolumeMetrics.total_volume:type_name -> poolrpc.WeeklyVolumeMetrics.TotalVolumeEntry
	26,  // 81: poolrpc.OrderMatchReject.RejectedOrdersEntry.value:type_name -> poolrpc.OrderReject
	27,  // 82: poolrpc.OrderMatchSign.ChannelInfosEntry.value:type_name -> poolrpc.ChannelInfo
	40,  // 83: poolrpc.MatchedMarket.MatchedOrdersEntry.value:type_name -> poolrpc.MatchedOrder
	40,  // 84: poolrpc.OrderMatchPrepare.MatchedOrdersEntry.value:type_name -> poolrpc.MatchedOrder
	33,  // 85: poolrpc.OrderMatchPrepare.MatchedMarketsEntry.value:type_name -> poolrpc.MatchedMarket
	7,   // 86: poolrpc.TermsResponse.LeaseDurationBucketsEntry.value:type_name -> poolrpc.DurationBucketState
	40,  // 87: poolrpc.RelevantBatch.MatchedOrdersEntry.value:type_name -> poolrpc.MatchedOrder
	33,  // 88: poolrpc.RelevantBatch.MatchedMarketsEntry.value:type_name -> poolrpc.MatchedMarket
	66,  // 89: poolrpc.BatchSnapshotResponse.MatchedMarketsEntry.value:type_name -> poolrpc.MatchedMarketSnapshot
	3,   // 90: poolrpc.MarketInfo.TierValue.tier:type_name -> poolrpc.NodeTier
	74,  // 91: poolrpc.MarketInfoResponse.MarketsEntry.value:type_name -> poolrpc.MarketInfo
	77,  // 92: poolrpc.OrderMetricsResponse.OrderMetricsByLeaseDurationEntry.value:type_name -> poolrpc.OrderMetrics
	82,  // 93: poolrpc.BatchMetricsResponse.BatchMetricsByTimeframeEntry.value:type_name -> poolrpc.BatchMetricsByLeaseDuration
	83,  // 94: poolrpc.BatchMetricsResponse.WeeklyVolumeMetricsByDurationEntry.value:type_name -> poolrpc.WeeklyVolumeMetrics
	80,  // 95: poolrpc.BatchMetricsByLeaseDuration.BatchMetricsByDurationEntry.value:type_name -> poolrpc.BatchMetrics
	13,  // 96: poolrpc.ChannelAuctioneer.ReserveAccount:input_type -> poolrpc.ReserveAccountRequest
	15,  // 97: poolrpc.ChannelAuctioneer.InitAccount:input_type -> poolrpc.ServerInitAccountRequest
	51,  // 98: poolrpc.ChannelAuctioneer.ModifyAccount:input_type -> poolrpc.ServerModifyAccountRequest
	17,  // 99: poolrpc.ChannelAuctioneer.SubmitOrder:input_type -> poolrpc.ServerSubmitOrderRequest
	19,  // 100: poolrpc.ChannelAuctioneer.CancelOrder:input_type -> poolrpc.ServerCancelOrderRequest
	53,  // 101: poolrpc.ChannelAuctioneer.OrderState:input_type -> poolrpc.ServerOrderStateRequest
	21,  // 102: poolrpc.ChannelAuctioneer.SubscribeBatchAuction:input_type -> poolrpc.ClientAuctionMessage
	21,  // 103: poolrpc.ChannelAuctioneer.SubscribeSidecar:input_type -> poolrpc.ClientAuctionMessage
	55,  // 104: poolrpc.ChannelAuctioneer.Terms:input_type -> poolrpc.TermsRequest
	57,  // 105: poolrpc.ChannelAuctioneer.RelevantBatchSnapshot:input_type -> poolrpc.RelevantBatchRequest
	65,  // 106: poolrpc.ChannelAuctioneer.BatchSnapshot:input_type -> poolrpc.BatchSnapshotRequest
	68,  // 107: poolrpc.ChannelAuctioneer.NodeRating:input_type -> poolrpc.ServerNodeRatingRequest
	71,  // 108: poolrpc.ChannelAuctioneer.BatchSnapshots:input_type -> poolrpc.BatchSnapshotsRequest
	73,  // 109: poolrpc.ChannelAuctioneer.MarketInfo:input_type -> poolrpc.MarketInfoRequest
	79,  // 110: poolrpc.ChannelAuctioneer.BatchMetrics:input_type -> poolrpc.BatchMetricsRequest
	76,  // 111: poolrpc.ChannelAuctioneer.OrderMetrics:input_type -> poolrpc.OrderMetricsRequest
	14,  // 112: poolrpc.ChannelAuctioneer.ReserveAccount:output_type -> poolrpc.ReserveAccountResponse
	16,  // 113: poolrpc.ChannelAuctioneer.InitAccount:output_type -> poolrpc.ServerInitAccountResponse
	52,  // 114: poolrpc.ChannelAuctioneer.ModifyAccount:output_type -> poolrpc.ServerModifyAccountResponse
	18,  // 115: poolrpc.ChannelAuctioneer.SubmitOrder:output_type -> poolrpc.ServerSubmitOrderResponse
	20,  // 116: poolrpc.ChannelAuctioneer.CancelOrder:output_type -> poolrpc.ServerCancelOrderResponse
	54,  // 117: poolrpc.ChannelAuctioneer.OrderState:output_type -> poolrpc.ServerOrderStateResponse
	30,  // 118: poolrpc.ChannelAuctioneer.SubscribeBatchAuction:output_type -> poolrpc.ServerAuctionMessage
	30,  // 119: poolrpc.ChannelAuctioneer.SubscribeSidecar:output_type -> poolrpc.ServerAuctionMessage
	56,  // 120: poolrpc.ChannelAuctioneer.Terms:output_type -> poolrpc.TermsResponse
	58,  // 121: poolrpc.ChannelAuctioneer.RelevantBatchSnapshot:output_type -> poolrpc.RelevantBatch
	67,  // 122: poolrpc.ChannelAuctioneer.BatchSnapshot:output_type -> poolrpc.BatchSnapshotResponse
	70,  // 123: poolrpc.ChannelAuctioneer.NodeRating:output_type -> poolrpc.ServerNodeRatingResponse
	72,  // 124: poolrpc.ChannelAuctioneer.BatchSnapshots:output_type -> poolrpc.BatchSnapshotsResponse
	75,  // 125: poolrpc.ChannelAuctioneer.MarketInfo:output_type -> poolrpc.MarketInfoResponse
	81,  // 126: poolrpc.ChannelAuctioneer.BatchMetrics:output_type -> poolrpc.BatchMetricsResponse
	78,  // 127: poolrpc.ChannelAuctioneer.OrderMetrics:output_type -> poolrpc.OrderMetricsResponse
...
func file_auctioneer_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_auctioneer_proto_msgTypes[63].Exporter = func(v interface{}, i int) interface{} {
		...
		file_auctioneer_proto_msgTypes[64].Exporter = func(v interface{}, i int) interface{} {
		...
		file_auctioneer_proto_msgTypes[65].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*OrderMetricsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_auctioneer_proto_msgTypes[66].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BatchMetricsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_auctioneer_proto_msgTypes[67].Exporter = func(v interface{}, i int) interface{} {
		...
		file_auctioneer_proto_msgTypes[68].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BatchMetricsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_auctioneer_proto_msgTypes[69].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BatchMetricsByLeaseDuration); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_auctioneer_proto_msgTypes[70].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*WeeklyVolumeMetrics); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_auctioneer_proto_msgTypes[79].Exporter = func(v interface{}, i int) interface{} {
		...
		file_auctioneer_proto_msgTypes[85].Exporter = func(v interface{}, i int) interface{} {
...
type ChannelAuctioneerClient interface {
	...
	BatchMetrics(ctx context.Context, in *BatchMetricsRequest, opts ...grpc.CallOption) (*BatchMetricsResponse, error)
	OrderMetrics(ctx context.Context, in *OrderMetricsRequest, opts ...grpc.CallOption) (*OrderMetricsResponse, error)
}
...
func (c *channelAuctioneerClient) SubscribeSidecar(ctx context.Context, opts ...grpc.CallOption) (ChannelAuctioneer_SubscribeSidecarClient, error) {
	stream, err := c.cc.NewStream(ctx, &_ChannelAuctioneer_serviceDesc.Streams[1], "/poolrpc.ChannelAuctioneer/SubscribeSidecar", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *channelAuctioneerClient) BatchMetrics(ctx context.Context, in *BatchMetricsRequest, opts ...grpc.CallOption) (*BatchMetricsResponse, error) {
	out := new(BatchMetricsResponse)
	err := c.cc.Invoke(ctx, "/poolrpc.ChannelAuctioneer/BatchMetrics", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *channelAuctioneerClient) OrderMetrics(ctx context.Context, in *OrderMetricsRequest, opts ...grpc.CallOption) (*OrderMetricsResponse, error) {
	out := new(OrderMetricsResponse)
	err := c.cc.Invoke(ctx, "/poolrpc.ChannelAuctioneer/OrderMetrics", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ChannelAuctioneerServer interface {
	...
	BatchMetrics(context.Context, *BatchMetricsRequest) (*BatchMetricsResponse, error)
	OrderMetrics(context.Context, *OrderMetricsRequest) (*OrderMetricsResponse, error)
}
...
func (*UnimplementedChannelAuctioneerServer) BatchMetrics(context.Context, *BatchMetricsRequest) (*BatchMetricsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method BatchMetrics not implemented")
}
func (*UnimplementedChannelAuctioneerServer) OrderMetrics(context.Context, *OrderMetricsRequest) (*OrderMetricsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method OrderMetrics not implemented")
}
...
func _ChannelAuctioneer_BatchMetrics_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BatchMetricsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ChannelAuctioneerServer).BatchMetrics(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/poolrpc.ChannelAuctioneer/BatchMetrics",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChannelAuctioneerServer).BatchMetrics(ctx, req.(*BatchMetricsRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _ChannelAuctioneer_OrderMetrics_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(OrderMetricsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ChannelAuctioneerServer).OrderMetrics(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/poolrpc.ChannelAuctioneer/OrderMetrics",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChannelAuctioneerServer).OrderMetrics(ctx, req.(*OrderMetricsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ChannelAuctioneer_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "BatchMetrics",
			Handler:    _ChannelAuctioneer_BatchMetrics_Handler,
		},
		{
			MethodName: "OrderMetrics",
			Handler:    _ChannelAuctioneer_OrderMetrics_Handler,
		},
	},
